import ImageEnumObjectConst from './enum-object-const.png';
...
<img src={ImageEnumObjectConst} width="400"/>
...
```typescript
// Type Utility
type ToEnum<T> = T[keyof T];

type PostStateType = ToEnum<typeof PostState>;
```
